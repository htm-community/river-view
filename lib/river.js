...
River.prototype.saveTemporalData = function(err, id, timestamp, data) {
...
River.prototype.saveGeotemporalData = function(err, id, timestamp, data) {
    // TODO: handle this error properly.
    if (err) throw err;
    this.redisClient.writeRiverTemporalData(this.name, id, timestamp, data, this.expires, function(error) {
        // TODO: handle this error properly.
...
River.prototype.saveMetaData = function(err, id, data) {
    // TODO: handle this error properly.
    if (err) throw err;
